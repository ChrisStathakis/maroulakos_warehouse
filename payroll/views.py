...
from .forms import PayrollForm, PersonForm, OccupationForm, PayrollPersonForm, CreateManyInvoicesForm
from .tables import PayrollTable, PersonTable, OccupationTable, PayrollCardTable
...
class PersonCardView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['queryset_table'] = PayrollCardTable(Payroll.objects.filter(person=self.object))
        return context
